...
module.exports = function(h, modules, classes, slots) {
  ...
  var perpage =  perpageValues.length>0?<div class="VueTables__limit-field">
  ...
  // var PagingLimit = <div class={`${classes.field} ${classes.inline} ${classes.right} VueTables__limit`}>
  //     {slots.beforeLimit}
  //     {perpage}
  //     {slots.afterLimit}
  // </div>
